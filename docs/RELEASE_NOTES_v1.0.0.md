...
NotionHub 可以通过 GitHub Actions，把微信读书数据自动同步到一套可直接 Duplicate 的 Notion 阅读管理模板，无需自己部署服务器。

![NotionHub 同步后的 Notion 阅读仪表盘](https://raw.githubusercontent.com/wslh/NotionHub/main/asset/notion-dashboard.png)
